...
const NotificationModal: React.FC<NotificationModalProps> = ({
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-start sm:items-center justify-center bg-black/60 backdrop-blur-sm p-4 pt-20 sm:pt-4 animate-in fade-in duration-200 overflow-y-auto">
      <div className="bg-slate-900/95 backdrop-blur-2xl rounded-3xl shadow-2xl max-w-2xl w-full max-h-[85vh] sm:max-h-[80vh] flex flex-col border-2 border-white/10 my-auto">
        {/* Header */}
