...
export class AuthController {
    ...
    static async refresh(req, res) {
      ...
      `, [decoded.sessionId, refreshToken]);
        ...
        WHERE id = ?
      `, [decoded.sessionId]);
            const newAccessToken = jwt.sign({ userId: user.id, username: user.username, is_admin: user.is_admin }, JWT_SECRET, { expiresIn: JWT_EXPIRES_IN });
    ...
    static async generateTokens(user) {
        ...
        const accessToken = jwt.sign({ userId: user.id, username: user.username, is_admin: user.is_admin }, JWT_SECRET, { expiresIn: JWT_EXPIRES_IN });
